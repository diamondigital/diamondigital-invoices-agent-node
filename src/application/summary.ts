...
function classifyResults(results: ProcessResult[]): ClassifiedResults {
  return {
...
export function buildSummaryLines(results: ProcessResult[]): string[] {
...
export async function sendSummary(results: ProcessResult[], notification: NotificationPort): Promise<void> {
